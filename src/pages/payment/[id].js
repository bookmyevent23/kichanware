...
const Payments = () => {
    ...
    console.log(products);
    const upiString = `upi://pay?pa=${encodeURIComponent(products.upi)}&am=${encodeURIComponent(router.query.id)}`;
    return (
        products?.upi !== null && products?.upi !== "" ?
            activeTab === 5 ?
                <div className="upi-qr-container p-5 h-100">
                    <h2 className="upi-qr-title">UPI QR Code Generator</h2>
                    <div className="upi-qr-code py-4">
                        <QRCode value={upiString} style={{ maxWidth: "100%", width: "100%", height: "auto" }} />
                    </div>
                    <div class="mt-5"><h4 className="text-center">Time Remaining:{minutes}min {seconds}sec</h4></div>
                    <div><a href="/" class="btn btn-primary w-50 d-block m-auto py-3 my-3">Continue</a>
                        <button class="mt-4 d-block m-auto btn" onClick={() => {
                            setActiveTab(2);
                        }}>Exit</button>
                    </div>
                </div> :
                <div>
                            ...
                            >
                                <label className="form-check-label">
                                    <img
                                        ...
                                        style={{ maxWidth: 45 }}
                                    />
                                    <span className="unaviablee mx-4">Qr code</span>
                                </label>
                            </div>
                        </div>
                    </div>
                    <div className="card px-3 py-4 mb-2" id="price-detail">
                        ...
                        <div className="price-detail-div mt-2">
                            <div className="product-price-list my-3">
                                ...
                                <span className="data selling_price me-0 td-none">₹ {router.query.id?.split('.')[1]}</span>
                            </div>
                            <div className="product-price-list my-3">
                            ...
                            <div className="product-price-list mt-3 pt-3 total">
                                ...
                                <span className="data selling_price">₹  {router.query.id?.split('.')[0]}</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <span className="selling_price" id="selling_price">
                        ...
                        <div className="col-6 footer-price">
                            <span className="strike mrp ms-0 mb-1" id="mrp">
                                - ₹  {Number(router.query.id?.split('.')[1]) || 0}
                            </span>
                            <span className="selling_price" id="selling_price">
                                ₹ {Number(router.query.id?.split('.')[0]) || 0}
                            </span>
                        </div>
                        <button
